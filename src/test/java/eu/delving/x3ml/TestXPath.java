...
public class TestXPath {
    ...
    @Test
    public void testWithXpath() throws FileNotFoundException {
        X3MLEngine engine = engine("/xpath/mappings.x3ml");
        X3MLEngine.Output output = engine.execute(document("/xpath/input.xml"),VALUE_POLICY);
        String[] mappingResult = output.toStringArray();
        String[] expectedResult = xmlToNTriples("/xpath/expectedOutput.rdf");
